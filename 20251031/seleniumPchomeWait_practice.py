...
print('-------------------------------------------------')
browser.get(url)
keyword=browser.find_element(By.CLASS_NAME,'l-header__siteSearchInput')
keyword.send_keys(word)
botton = browser.find_element(By.CSS_SELECTOR,'div.l-header__siteSearchBtn button.btn')
botton.click()
